...
enum PostureVisualizationDevNotes {
    ...
    static let changes: [String] = [
        ...
        "2D gains baked from device tuning (2026-06-19): side lean 70→20 (70 over-tilted), head turn -0.6 (kept), head NOD +1.0→-3.0 (was reversed + too weak), head TILT +1.0→-3.0 (same), zoom 0.5 (kept). All confirmed correct in isolation via the 'iso' solos.",
